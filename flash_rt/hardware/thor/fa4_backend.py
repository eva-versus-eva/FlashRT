...
FA4's Blackwell forward kernel runs on Thor through the supported SM101 codegen
alias, while ``FLASH_ATTENTION_ARCH=sm_110`` keeps runtime dispatch on the
Thor-compatible generic path.
...
def _load() -> None:
    ...
    # Set the supported Thor alias before importing CUTLASS: its environment
    # manager caches the detected architecture during the first import.
    os.environ.setdefault("CUTE_DSL_ARCH", "sm_101a")
    os.environ.setdefault("FLASH_ATTENTION_ARCH", "sm_110")
